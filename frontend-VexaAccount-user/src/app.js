...
(()=>{if(window.__VEXA_ACCOUNT_RUNTIME_LOADING__)return;window.__VEXA_ACCOUNT_RUNTIME_LOADING__=true;
  ...
  const toastRuntime=document.createElement('script');toastRuntime.src='./src/vexatrade-toast-runtime.js?v=20260901-2';toastRuntime.defer=true;document.head.appendChild(toastRuntime);
  const bridge=document.createElement('script');bridge.src='./src/auth-flow-fix.js?v=20260901-4';bridge.defer=true;
  bridge.onload=()=>{const s=document.createElement('script');s.src='./src/app-fixed.js?v=20260901-14';s.defer=true;document.head.appendChild(s)};
