...
function loadCompat(){if(document.querySelector('script[data-vexa-account-runtime="account-center-v2-compat.js"]'))return;const s=document.createElement('script');s.src='./src/account-center-v2-compat.js?v=20260902-31';s.dataset.vexaAccountRuntime='account-center-v2-compat.js';document.body.appendChild(s)}
function load(){if(loading||window.__VEXA_ACCOUNT_CENTER_READY__||AUTH.test(location.hash||'')||!token())return;loading=true;exposeRoot();const s=document.createElement('script');s.src='./src/account-center-runtime-v2.js?v=20260902-31';s.dataset.vexaAccountRuntime='account-center-runtime-v2.js';s.onload=()=>{loading=false;loadCompat()};s.onerror=()=>{loading=false;console.error('[VexaAccount] Account Center runtime failed to load')};document.body.appendChild(s)}
