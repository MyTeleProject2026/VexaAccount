...
const nativeFetch=window.fetch.bind(window),inflight=new Map(),cache=new Map(),cooldown=new Map(),writeChains=new Map();
...
const authFailureUntil=new Map(),networkFailureUntil=new Map();
