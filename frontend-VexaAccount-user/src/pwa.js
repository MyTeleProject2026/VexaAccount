...
let deferredPrompt=null,registration=null,refreshing=false;
...
function showUpdate(){if(!registration?.waiting)return;banner('vexa-pwa-update','A new VexaAccount version is ready.','Update',()=>registration.waiting?.postMessage({type:'SKIP_WAITING'}))}
